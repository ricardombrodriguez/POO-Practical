...
public class Ementa {
	...
	//Dicionário/HashMap (Key (Dia da Semana) ---> Value (Array dos pratos do dia))
	...
	public void addPrato(Prato p, DiaSemana diaSemana) {
		pratos.get(diaSemana.name()).add(p);
	}
	...
	public String toString() {
		...
		for(String dia : dias) {
			for(Prato prato : pratos.get(dia)) {
				lista += prato.toString()+", dia "+dia+"\n";
			}
		}
		return lista;
	}
